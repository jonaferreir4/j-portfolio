...
export function getTechnologies(locale: Locale = 'pt') {
  ...
  return [
    {
      ...
      description: isEn ? "Reactive interfaces, modernization, and design systems." : "Interfaces reativas, modernização e design systems.",
      tools: [
    ...
    },
    {
      ...
      icon: <Server size={24} />,
      description: isEn ? "Robust architectures, microservices, and APIs." : "Arquiteturas robustas, microsserviços e APIs.",
      tools: [
        ...
        { name: "Applied AI", icon: <Sparkles size={14} /> }
      ]
    },
    {
      category: "Data & Persistence",
      icon: <Database size={24} />,
      description: isEn ? "Data modeling, ORMs, optimization, and caching." : "Modelagem, ORMs, otimização e cache.",
      tools: [
...
export const technologies = getTechnologies('pt');

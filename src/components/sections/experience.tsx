            ...
            <div key={exp.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              >
                ...
                <div className="bg-armor border border-borderTech p-6 hover:border-tacticalHighlight transition-colors duration-200 clip-tech relative">
                  ...
                  <h4 className="text-sm font-bold text-steel mb-4 uppercase tracking-wide relative z-10">
                      {exp.role}
                  </h4>
                    ...
                    <div className="mb-6 relative z-10 space-y-4">
                      {exp.projects.map((project, pIdx) => (
                        <div key={pIdx} className="mb-6 last:mb-0">
                          <h5 className="text-sm font-bold text-primary mb-3">{project.name}</h5>
                          
                          {project.image && (
                            <div className="mb-4 w-full h-40 sm:h-48 rounded overflow-hidden border border-borderTech/50 relative group/img">
                              <Image 
                                src={project.image} 
                                alt={project.name} 
                                fill
                          ...
                          <ul className="list-disc list-outside ml-4 space-y-1 text-steel text-xs leading-relaxed mb-2">
